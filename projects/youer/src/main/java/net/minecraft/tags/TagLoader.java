...
public class TagLoader<T> {
    ...
    public Map<ResourceLocation, Collection<T>> build(Map<ResourceLocation, List<TagLoader.EntryWithSource>> p_203899_) {
        p_203899_ = io.papermc.paper.tag.PaperTagListenerManager.INSTANCE.firePreFlattenEvent(p_203899_, loadAndBuild$eventConfig);
        ...
        return io.papermc.paper.tag.PaperTagListenerManager.INSTANCE.firePostFlattenEvent(map, loadAndBuild$eventConfig); // Paper - fire tag registrar events
    }

    public @Nullable io.papermc.paper.tag.TagEventConfig<T, ?> loadAndBuild$eventConfig;
