...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider, GeneratingChunkMap {
    ...
    public final AtomicInteger tickingGenerated = new AtomicInteger(); // Folia - region threading - public
    ...
    public final WorldGenContext worldGenContext; // Folia - region threading - public
    ...
    public ChunkMap(
        ...
        p_214843_.createState$conf.set(p_214836_.spigotConfig);
        this.chunkGeneratorState = p_214843_.createState(registryaccess.lookupOrThrow(Registries.STRUCTURE_SET), this.randomState, i); // Spigot
    ...
    public CompoundTag upgradeChunkTag(CompoundTag nbttagcompound, ChunkPos chunkcoordintpair) { // Paper - public
        return this.upgradeChunkTagCB(this.level.dimension(), this.overworldDataStorage, nbttagcompound, this.generator().getTypeNameForDataFixer(), chunkcoordintpair, this.level);
        // CraftBukkit end
    }
    ...
    protected void tick() {
        ...
        if (!list.isEmpty()) {
            Int2ObjectMap<ChunkMap.TrackedEntity> entityMaps =  new Int2ObjectOpenHashMap<>(this.entityMap);
            for (ChunkMap.TrackedEntity chunkmap$trackedentity1 : entityMaps.values()) {
    ...
    public class TrackedEntity {
        ...
        public void updatePlayer(ServerPlayer p_140498_) {
            if (p_140498_ != this.entity) {
                ...
                if (flag && !p_140498_.getBukkitEntity().canSee(this.entity.getBukkitEntity())) {  // Paper - only consider hits
                    flag = false;
                }
                // CraftBukkit end
