...
public class ScheduleCommand {
    ...
    private static final SuggestionProvider<CommandSourceStack> SUGGEST_SCHEDULE = (p_138424_, p_138425_) -> SharedSuggestionProvider.suggest(
            p_138424_.getSource().getLevel().K.getScheduledEvents().getEventsIds(), p_138425_
        );
    ...
    private static int schedule(
        ...
        if (p_138431_ == 0) {
            ...
            TimerQueue<MinecraftServer> timerqueue = p_138429_.getLevel().K.overworldData().getScheduledEvents();
            p_138430_.getSecond()
                .ifLeft(
                    p_305875_ -> {
                        ...
                        p_138429_.sendSuccess(
                            () -> Component.translatable("commands.schedule.created.function", Component.translationArg(resourcelocation), p_138431_, i), true
                        );
                    }
                )
                .ifRight(
                    p_339441_ -> {
                        ...
                        p_138429_.sendSuccess(
                            () -> Component.translatable("commands.schedule.created.tag", Component.translationArg(resourcelocation), p_138431_, i), true
                        );
                    }
                );
    ...
    private static int remove(CommandSourceStack p_138434_, String p_138435_) throws CommandSyntaxException {
        int i = p_138434_.getLevel().K.getScheduledEvents().remove(p_138435_);
        if (i == 0) {
