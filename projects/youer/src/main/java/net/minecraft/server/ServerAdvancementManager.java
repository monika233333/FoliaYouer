...
public class ServerAdvancementManager extends SimpleJsonResourceReloadListener {
    ...
    protected void apply(Map<ResourceLocation, JsonElement> p_136034_, ResourceManager p_136035_, ProfilerFiller p_136036_) {
        ...
        p_136034_.forEach((p_337529_, p_337530_) -> {
            // Spigot start
            if (org.spigotmc.SpigotConfig.disabledAdvancements != null && (org.spigotmc.SpigotConfig.disabledAdvancements.contains("*") || org.spigotmc.SpigotConfig.disabledAdvancements.contains(p_337529_.toString()) || org.spigotmc.SpigotConfig.disabledAdvancements.contains(p_337529_.getNamespace()))) {
                return;
            }
            // Spigot end
            try {
