...
public record PlayerChatMessage(
    ...
    public PlayerChatMessage withUnsignedContent(Component p_242164_) {
        ...
        if (p_242164_ instanceof io.papermc.paper.adventure.AdventureComponent advComponent) {
            component = this.signedContent().equals(io.papermc.paper.adventure.AdventureCodecs.tryCollapseToString(advComponent.adventure$component())) ? null : p_242164_;
        } else {
            component = !p_242164_.equals(Component.literal(this.signedContent())) ? p_242164_ : null;
        }
        // Paper end - adventure
