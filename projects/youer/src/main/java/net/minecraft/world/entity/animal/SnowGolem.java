...
public class SnowGolem extends AbstractGolem implements Shearable, RangedAttackMob {
    ...
    public void addAdditionalSaveData(CompoundTag p_29923_) {
        ...
        if (getSummoner() != null) p_29923_.putUUID("Purpur.Summoner", getSummoner()); // Purpur
    }
    ...
    public void readAdditionalSaveData(CompoundTag p_29915_) {
        ...
        if (p_29915_.contains("Purpur.Summoner")) setSummoner(p_29915_.getUUID("Purpur.Summoner")); // Purpur
    }
        ...
        if (!this.level().isClientSide) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (this.level().getBlockState(blockpos).isAir() && blockstate.canSurvive(this.level(), blockpos)) {
                    // CraftBukkit start
                    if (!CraftEventFactory.handleBlockFormEvent(this.level(), blockpos, blockstate, this)) {
                        continue;
                    }
                    // CraftBukkit end
    ...
    @Override
    public void shearPaper(SoundSource p_331493_, java.util.List<net.minecraft.world.item.ItemStack> drops) {
        shear$drops = drops;
        this.shear(p_331493_);
    }
