...
public abstract class AbstractMinecartContainer extends AbstractMinecart implements ContainerEntity {
    ...
    public int getMaxStackSize() {
        return Math.max(ContainerEntity.super.getMaxStackSize(), maxStack);
    }
    ...
    public void remove(Entity.RemovalReason p_150255_) {
        ...
        this.removeCB(p_150255_, null);
    }

    @Override
    public void removeCB(Entity.RemovalReason p_150255_, org.bukkit.event.entity.EntityRemoveEvent.Cause cause) {
        // CraftBukkit end
        if (!this.level().isClientSide && p_150255_.shouldDestroy()) {
            Containers.dropContents(this.level(), this, this);
        }

        super.removeCB(p_150255_, cause); // CraftBukkit - add Bukkit remove cause
    }
    ...
    public void setLootTable(ResourceKey<LootTable> p_335456_, long p_38238_) {
        this.lootTable = p_335456_;
