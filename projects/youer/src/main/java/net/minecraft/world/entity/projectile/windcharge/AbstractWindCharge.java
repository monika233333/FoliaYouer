...
public abstract class AbstractWindCharge extends AbstractHurtingProjectile implements ItemSupplier {
    ...
    @Override
    public boolean canHitEntity(Entity p_326159_) {
    ...
    @Override
    public void push(double p_334071_, double p_333979_, double p_333996_, @org.jetbrains.annotations.Nullable Entity pushingEntity) {} // Paper - Add EntityKnockbackByEntityEvent and EntityPushedByEntityAttackEvent

    public abstract void explode(Vec3 p_352265_);
