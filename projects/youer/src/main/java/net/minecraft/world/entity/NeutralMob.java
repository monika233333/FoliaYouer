...
public interface NeutralMob {
    ...
    default boolean isAngryAt(LivingEntity p_21675_) {
        if (!this.canAttack(p_21675_)) {
            ...
            return p_21675_.getType() == EntityType.PLAYER && this.isAngryAtAllPlayers(p_21675_.level())
                ? true
                : p_21675_.getUUID().equals(this.getPersistentAngerTarget());
        }
    }
    ...
    default void stopBeingAngry() {
        ...
        this.setPersistentAngerTarget(null);
        this.setTargetCB(null, org.bukkit.event.entity.EntityTargetEvent.TargetReason.FORGOT_TARGET, true); // CraftBukkit
    ...
    boolean setTargetCB(@Nullable LivingEntity entityliving, org.bukkit.event.entity.EntityTargetEvent.TargetReason reason, boolean fireEvent); // CraftBukkit
    ...
    default void tickInitialPersistentAnger(Level level) {
        ...
        if (entity != null) {
            if (entity instanceof Mob mob) {
                this.setTargetCB(mob, EntityTargetEvent.TargetReason.UNKNOWN, false); // CraftBukkit
                this.setLastHurtByMob(mob);
            }

            if (entity instanceof Player player) {
                this.setTargetCB(player, EntityTargetEvent.TargetReason.UNKNOWN, false); // CraftBukkit
