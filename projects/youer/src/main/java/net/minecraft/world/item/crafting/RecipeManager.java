...
public class RecipeManager extends SimpleJsonResourceReloadListener {
    ...
    public <I extends RecipeInput, T extends Recipe<I>> Optional<RecipeHolder<T>> getRecipeFor(
        ...
        if (p_345826_.isEmpty()) {
            ...
            if (p_346407_ != null && p_346407_.value().matches(p_345826_, p_220251_)) return Optional.of(p_346407_);
            List<RecipeHolder<T>> list = this.byType(p_220249_).stream().filter(p_344413_ -> p_344413_.value().matches(p_345826_, p_220251_)).toList();
    ...
    @Nullable
    public RecipeHolder<?> previousRecipe = null;
    public <I extends RecipeInput, T extends Recipe<I>> NonNullList<ItemStack> getRemainingItemsFor(RecipeType<T> p_44070_, I p_345118_, Level p_44072_) {
        ...
        Optional<RecipeHolder<T>> optional = this.getRecipeFor(p_44070_, p_345118_, p_44072_, (RecipeHolder<T>) previousRecipe);
    ...
    public <I extends RecipeInput, T extends Recipe<I>> NonNullList<ItemStack> getRemainingItemsForPaper(RecipeType<T> p_44070_, I p_345118_, Level p_44072_, @Nullable RecipeHolder<T> previousRecipe) {
        this.previousRecipe = previousRecipe;
        return getRemainingItemsFor(p_44070_, p_345118_, p_44072_);
    }
