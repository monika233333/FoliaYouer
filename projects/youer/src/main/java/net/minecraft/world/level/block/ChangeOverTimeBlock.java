...
public interface ChangeOverTimeBlock<T extends Enum<T>> {
    ...
    default void changeOverTime(BlockState p_309154_, ServerLevel p_309115_, BlockPos p_308999_, RandomSource p_308868_) {
        ...
        if (p_308868_.nextFloat() < 0.05688889F) {
            this.getNextState(p_309154_, p_309115_, p_308999_, p_308868_).ifPresent(p_153039_ ->
                CraftEventFactory.handleBlockFormEvent(p_309115_, p_308999_, p_153039_) // CraftBukkit
            );
        }
    }
