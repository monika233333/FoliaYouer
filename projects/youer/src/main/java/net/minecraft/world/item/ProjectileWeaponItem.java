    ...
    protected void shoot(
        ...
        for (int i = 0; i < p_331726_.size(); i++) {
            ...
            if (!itemstack.isEmpty()) {
                ...
                // CraftBukkit start
                org.bukkit.event.entity.EntityShootBowEvent event = CraftEventFactory.callEntityShootBowEvent(p_330728_, p_330646_, itemstack, projectile, p_331152_, p_331007_, true);
