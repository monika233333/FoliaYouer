                                ...
                                if (!globalpos.pos().closerToCenterThan(p_258310_.position(), 2.0) && !p_258310_.assignProfessionWhenSpawned()) {
                                    ...
                                    if (p_258310_.getVillagerData().getProfession() != VillagerProfession.NONE) {
                                        ...
                                        Optional.ofNullable(minecraftserver.getLevel(globalpos.dimension()))
                                            ...
                                            .flatMap(
                                                p_344306_ -> BuiltInRegistries.VILLAGER_PROFESSION
                                                        .stream()
                                                        .filter(p_217125_ -> p_217125_.heldJobSite().test((Holder<PoiType>)p_344306_))
                                                        .findFirst()
                                            )
                                            .ifPresent(p_22464_ -> {
                                                // CraftBukkit start - Fire VillagerCareerChangeEvent where Villager gets employed
                                                org.bukkit.event.entity.VillagerCareerChangeEvent event = CraftEventFactory.callVillagerCareerChangeEvent(p_258310_, CraftVillager.CraftProfession.minecraftToBukkit(p_22464_), org.bukkit.event.entity.VillagerCareerChangeEvent.ChangeReason.EMPLOYED);
