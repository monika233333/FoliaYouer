...
public class ItemFrame extends HangingEntity {
    ...
    public void setItem(ItemStack p_31790_, boolean p_31791_) {
        ...
        if (!p_31790_.isEmpty() && p_31791_ && setItem$playSound.getAndSet(true)) {  // CraftBukkit // Paper - only play sound when update flag is set
    ...
    AtomicBoolean setItem$playSound = new AtomicBoolean(true);
    public void setItem(ItemStack p_31790_, boolean p_31791_, boolean playSound) {
        setItem$playSound.set(playSound);
        setItem(p_31790_, p_31791_);
    }
    ...
    private void onItemChanged(ItemStack p_218866_) {
        this.cachedMapId = p_218866_.getComponents().get(net.minecraft.core.component.DataComponents.MAP_ID); // Paper - Perf: Cache map ids on item frames
