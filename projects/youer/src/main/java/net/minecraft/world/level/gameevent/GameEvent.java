...
public record GameEvent(int notificationRadius) {
    ...
    public static Holder<GameEvent> bootstrap(Registry<GameEvent> p_316246_) {
        return BLOCK_ACTIVATE;
    }

    private static Holder.Reference<GameEvent> register(String p_157825_) {
        return register(p_157825_, 16);
    }

    private static Holder.Reference<GameEvent> register(String p_157823_, int p_316588_) {
        return io.papermc.paper.registry.PaperRegistryListenerManager.INSTANCE.registerForHolderWithListeners(BuiltInRegistries.GAME_EVENT, ResourceLocation.withDefaultNamespace(p_157823_), new GameEvent(p_316588_)); // Paper - run with listeners
    }
    ...
    public static final class ListenerInfo implements Comparable<GameEvent.ListenerInfo> {
        ...
        public ListenerInfo(Holder<GameEvent> p_316198_, Vec3 p_249118_, GameEvent.Context p_251196_, GameEventListener p_251701_, Vec3 p_248854_) {
            this.gameEvent = p_316198_;
