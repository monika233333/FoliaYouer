...
public class EnderpearlItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41190_, Player p_41191_, InteractionHand p_41192_) {
        ...
        if (!p_41190_.isClientSide) {
            ...
            com.destroystokyo.paper.event.player.PlayerLaunchProjectileEvent event = new com.destroystokyo.paper.event.player.PlayerLaunchProjectileEvent((org.bukkit.entity.Player) p_41191_.getBukkitEntity(), org.bukkit.craftbukkit.inventory.CraftItemStack.asCraftMirror(itemstack), (org.bukkit.entity.Projectile) thrownenderpearl.getBukkitEntity());
            if (event.callEvent() && p_41190_.addFreshEntity(thrownenderpearl)) {
                if (event.shouldConsume()) {
                    itemstack.consume(1, p_41191_);
                } else if (p_41191_ instanceof net.minecraft.server.level.ServerPlayer) {
