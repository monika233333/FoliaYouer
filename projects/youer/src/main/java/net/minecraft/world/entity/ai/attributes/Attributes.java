...
public class Attributes {
    ...
    public static final Holder<Attribute> ATTACK_DAMAGE = register(
        "generic.attack_damage", new RangedAttribute("attribute.name.generic.attack_damage", 2.0, 0.0, org.spigotmc.SpigotConfig.attackDamage) // Spigot
    );
    ...
    public static final Holder<Attribute> MAX_ABSORPTION = register(
        "generic.max_absorption", new RangedAttribute("attribute.name.generic.max_absorption", 0.0, 0.0, org.spigotmc.SpigotConfig.maxAbsorption).setSyncable(true)
    );
    public static final Holder<Attribute> MAX_HEALTH = register(
        "generic.max_health", new RangedAttribute("attribute.name.generic.max_health", 20.0, 1.0, org.spigotmc.SpigotConfig.maxHealth).setSyncable(true)
    );
    ...
    public static final Holder<Attribute> MOVEMENT_SPEED = register(
        ...
        "generic.movement_speed", new net.neoforged.neoforge.common.PercentageAttribute("attribute.name.generic.movement_speed", 0.7, 0.0, org.spigotmc.SpigotConfig.movementSpeed, 1000).setSyncable(true)
    );
