...
public class Vex extends Monster implements TraceableEntity {
    ...
    public void restoreFrom(Entity p_306094_) {
        super.restoreFrom(p_306094_);
        if (p_306094_ instanceof Vex vex) {
    ...
    class VexCopyOwnerTargetGoal extends TargetGoal {
        ...
        @Override
        public void start() {
            Vex.this.setTargetReason(org.bukkit.event.entity.EntityTargetEvent.TargetReason.OWNER_ATTACKED_TARGET, true); // CraftBukkit
