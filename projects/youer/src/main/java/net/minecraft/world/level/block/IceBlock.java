...
public class IceBlock extends HalfTransparentBlock {
    ...
    protected void melt(BlockState p_54169_, Level p_54170_, BlockPos p_54171_) {
        // CraftBukkit start
        if (CraftEventFactory.callBlockFadeEvent(p_54170_, p_54171_, p_54170_.dimensionType().ultraWarm() ? Blocks.AIR.defaultBlockState() : Blocks.WATER.defaultBlockState()).isCancelled()) {
            return;
        }
        // CraftBukkit end
