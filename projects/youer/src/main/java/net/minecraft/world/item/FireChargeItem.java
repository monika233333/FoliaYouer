    ...
    public InteractionResult useOn(UseOnContext p_41204_) {
        ...
        if (blockstate2 == null) {
            ...
            if (BaseFireBlock.canBePlacedAt(level, blockpos, p_41204_.getHorizontalDirection())) {
                // CraftBukkit start - fire BlockIgniteEvent // Youer add null check
                if (p_41204_.getPlayer() != null && CraftEventFactory.callBlockIgniteEvent(level, blockpos, org.bukkit.event.block.BlockIgniteEvent.IgniteCause.FIREBALL, p_41204_.getPlayer()).isCancelled()) {
