...
public class ArmorStand extends LivingEntity {
                    ...
                    if (!flag1 && !flag) {
                        ...
                        if (p_31579_.isCreativePlayer()) {
                            ...
                            if (i - this.lastHit > 5L && !flag) {
                                ...
                                this.showBreakingParticles();
                                this.removeReason(org.bukkit.event.entity.EntityRemoveEvent.Cause.DEATH); // CraftBukkit - SPIGOT-4890: remain as this.discard() since above damagesource method will call death event
                                this.discard();
                            }
    ...
    public void kill() {
        ...
        removeReason(org.bukkit.event.entity.EntityRemoveEvent.Cause.DEATH);
