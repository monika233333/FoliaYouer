...
public class Digging<E extends Warden> extends Behavior<E> {
    ...
    protected void stop(ServerLevel p_217543_, E p_217544_, long p_217545_) {
        if (p_217544_.getRemovalReason() == null) {
            p_217544_.removeReason(org.bukkit.event.entity.EntityRemoveEvent.Cause.DESPAWN);
            p_217544_.remove(Entity.RemovalReason.DISCARDED); // CraftBukkit - Add bukkit remove cause
        }
    }
}
