...
public class WitherSkeleton extends AbstractSkeleton {
    ...
    protected void dropCustomDeathLoot(ServerLevel p_348522_, DamageSource p_34174_, boolean p_34176_) {
        super.dropCustomDeathLoot(p_348522_, p_34174_, p_34176_);
    ...
    public boolean doHurtTarget(Entity p_34169_) {
        if (!super.doHurtTarget(p_34169_)) {
            ...
            if (p_34169_ instanceof LivingEntity) {
                ((LivingEntity)p_34169_).addEffectCause(org.bukkit.event.entity.EntityPotionEffectEvent.Cause.ATTACK); // CraftBukkit
    ...
    @Override
    protected AbstractArrow getArrow(ItemStack p_34189_, float p_34190_, @Nullable ItemStack p_344843_) {
        AbstractArrow abstractarrow = super.getArrow(p_34189_, p_34190_, p_344843_);
    ...
    public boolean canBeAffected(MobEffectInstance p_34192_) {
        return p_34192_.is(MobEffects.WITHER) && this.level().paperConfig().entities.mobEffects.immuneToWitherEffect.witherSkeleton ? false : super.canBeAffected(p_34192_); // Paper - Add config for mobs immune to default effects
    }
}
