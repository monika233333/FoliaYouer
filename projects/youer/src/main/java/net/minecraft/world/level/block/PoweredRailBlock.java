...
public class PoweredRailBlock extends BaseRailBlock {
    ...
    protected boolean isSameRailWithPower(Level p_55226_, BlockPos p_55227_, boolean p_55228_, int p_55229_, RailShape p_55230_) {
        BlockState blockstate = !ca.spottedleaf.moonrise.common.util.TickThread.isTickThreadFor((ServerLevel)p_55226_, p_55227_) ? null : p_55226_.getBlockStateIfLoaded(p_55227_); // Folia - prevent block updates in non-loaded or non-owned chunks
        if (blockstate == null || !(blockstate.getBlock() instanceof PoweredRailBlock other)) { // Folia - prevent block updates in non-loaded or non-owned chunks
            return false;
        } else {
