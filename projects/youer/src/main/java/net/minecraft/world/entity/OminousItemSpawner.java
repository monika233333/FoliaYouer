...
public class OminousItemSpawner extends Entity {
    ...
    private void spawnItem() {
        ...
        if (!itemstack.isEmpty()) {
            ...
            entity.spawnReason(org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.OMINOUS_ITEM_SPAWNER); // Paper - Fixes and additions to the SpawnReason API
    ...
    public void setItem(ItemStack p_338789_) {
