...
public class Phantom extends FlyingMob implements Enemy {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_326421_) {
        super.defineSynchedData(p_326421_);
        p_326421_.define(ID_SIZE, 0);
    }
    ...
    public void readAdditionalSaveData(CompoundTag p_33132_) {
        ...
        // Paper start
        if (p_33132_.hasUUID("Paper.SpawningEntity")) {
            this.spawningEntity = p_33132_.getUUID("Paper.SpawningEntity");
        }
        // Paper end
    }
    ...
    public void addAdditionalSaveData(CompoundTag p_33141_) {
        ...
        if (this.spawningEntity != null) {
            p_33141_.putUUID("Paper.SpawningEntity", this.spawningEntity);
        }
        // Paper end
    }
    ...
    public EntityDimensions getDefaultDimensions(Pose p_316501_) {
        ...
        EntityDimensions entitydimensions = super.getDefaultDimensions(p_316501_);
                ...
                if (!list.isEmpty()) {
                    ...
                    for (Player player : list) {
                        if (Phantom.this.canAttack(player, TargetingConditions.DEFAULT)) {
                            ...
                            Phantom.this.setTargetReason(org.bukkit.event.entity.EntityTargetEvent.TargetReason.CLOSEST_PLAYER, true); // CraftBukkit - reason
