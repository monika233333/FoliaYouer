...
public class ChestBoat extends Boat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public void remove(Entity.RemovalReason p_219894_) {
        ...
        this.removeCB(p_219894_, null);
    }

    @Override
    public void removeCB(Entity.RemovalReason p_219894_, org.bukkit.event.entity.EntityRemoveEvent.Cause cause) {
        // CraftBukkit end
        if (!this.level().isClientSide && p_219894_.shouldDestroy()) {
            Containers.dropContents(this.level(), this, this);
        }

        super.removeCB(p_219894_, cause); // CraftBukkit - add Bukkit remove cause
    }
    ...
    public void openCustomInventoryScreen(Player p_219906_) {
        if (!p_219906_.level().isClientSide && p_219906_.openMenu(this).isPresent()) { // Paper - Fix InventoryOpenEvent cancellation
