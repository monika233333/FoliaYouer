...
public class FlowerPotBlock extends Block {
    ...
    protected ItemInteractionResult useItemOn(
        ...
        if (blockstate.isAir()) {
            ...
            org.bukkit.block.Block block = org.bukkit.craftbukkit.block.CraftBlock.at(p_316456_, p_316502_);
            org.bukkit.inventory.ItemStack placedStack = org.bukkit.craftbukkit.inventory.CraftItemStack.asBukkitCopy(p_316610_);

            io.papermc.paper.event.player.PlayerFlowerPotManipulateEvent event = new io.papermc.paper.event.player.PlayerFlowerPotManipulateEvent((org.bukkit.entity.Player) p_316491_.getBukkitEntity(), block, placedStack, true);
            if (!event.callEvent()) {
                // Update client
                p_316491_.containerMenu.sendAllDataToRemote();
    ...
    protected InteractionResult useWithoutItem(BlockState p_316363_, Level p_316655_, BlockPos p_316654_, Player p_316338_, BlockHitResult p_316518_) {
        if (this.isEmpty()) {
            ...
            // Paper start - Add PlayerFlowerPotManipulateEvent
            org.bukkit.block.Block block = org.bukkit.craftbukkit.block.CraftBlock.at(p_316655_, p_316654_);
            ...
            io.papermc.paper.event.player.PlayerFlowerPotManipulateEvent event = new io.papermc.paper.event.player.PlayerFlowerPotManipulateEvent((org.bukkit.entity.Player) p_316338_.getBukkitEntity(), block, pottedStack, false);
            if (!event.callEvent()) {
                // Update client
                p_316338_.containerMenu.sendAllDataToRemote();
