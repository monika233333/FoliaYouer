...
public class TemptingSensor extends Sensor<PathfinderMob> {
    ...
    protected void doTick(ServerLevel p_148331_, PathfinderMob p_148332_) {
        ...
        List<Player> list = p_148331_.players()
            ...
            .filter(p_325765_ -> !p_148332_.hasPassenger(p_325765_))
            .sorted(Comparator.comparingDouble(p_148332_::distanceToSqr))
            .collect(Collectors.toList());
        if (!list.isEmpty()) {
            Player player = list.get(0);
            // CraftBukkit start
            org.bukkit.event.entity.EntityTargetLivingEntityEvent event = CraftEventFactory.callEntityTargetLivingEvent(p_148332_, player, org.bukkit.event.entity.EntityTargetEvent.TargetReason.TEMPT);
