...
public class WaterlilyBlock extends BushBlock {
    ...
    protected void entityInside(BlockState p_58164_, Level p_58165_, BlockPos p_58166_, Entity p_58167_) {
        ...
        if (!new io.papermc.paper.event.entity.EntityInsideBlockEvent(p_58167_.getBukkitEntity(), org.bukkit.craftbukkit.block.CraftBlock.at(p_58165_, p_58166_)).callEvent()) { return; } // Paper - Add EntityInsideBlockEvent
        if (p_58165_ instanceof ServerLevel && p_58167_ instanceof Boat) {
            // CraftBukkit start
            if (!CraftEventFactory.callEntityChangeBlockEvent(p_58167_, p_58166_, p_58164_.getFluidState().createLegacyBlock())) { // Paper - fix wrong block state
                return;
            }
            // CraftBukkit end
