...
public abstract class AbstractSkeleton extends Monster implements RangedAttackMob {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_32146_, DifficultyInstance p_32147_, MobSpawnType p_32148_, @Nullable SpawnGroupData p_32149_) {
        ...
        this.reassessWeaponGoal();
        this.setCanPickUpLoot(this.level().paperConfig().entities.behavior.mobsCanAlwaysPickUpLoot.skeletons || randomsource.nextFloat() < 0.55F * p_32147_.getSpecialMultiplier());
    ...
    public void performRangedAttack(LivingEntity p_32141_, float p_32142_) {
        ...
        // CraftBukkit start
        org.bukkit.event.entity.EntityShootBowEvent event = CraftEventFactory.callEntityShootBowEvent(this, this.getMainHandItem(), abstractarrow.getPickupItem(), abstractarrow, net.minecraft.world.InteractionHand.MAIN_HAND, 0.8F, true);  // Paper
