...
public interface Shearable extends net.neoforged.neoforge.common.IShearable {
    default void shearPaper(SoundSource soundCategory, java.util.List<net.minecraft.world.item.ItemStack> drops) { this.shear(soundCategory); } // Paper - Add drops to shear events
