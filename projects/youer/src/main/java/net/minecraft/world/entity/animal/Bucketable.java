...
public interface Bucketable {
    ...
    static <T extends LivingEntity & Bucketable> Optional<InteractionResult> bucketMobPickup(Player p_148829_, InteractionHand p_148830_, T p_148831_) {
        ...
        if (itemstack.getItem() == Items.WATER_BUCKET && p_148831_.isAlive()) {
            ...
            org.bukkit.event.player.PlayerBucketEntityEvent playerBucketFishEvent = CraftEventFactory.callPlayerFishBucketEvent(p_148831_, p_148829_, itemstack, itemstack1, p_148830_);
            ...
            if (playerBucketFishEvent.isCancelled()) {
                ...
                p_148831_.resendPossiblyDesyncedEntityData((ServerPlayer) p_148829_); // Paper
