...
public class FurnaceResultSlot extends Slot {
    ...
    protected void checkTakeAchievements(ItemStack p_39558_) {
        ...
        if (this.player instanceof ServerPlayer serverplayer && this.container instanceof AbstractFurnaceBlockEntity abstractfurnaceblockentity) {
            abstractfurnaceblockentity.getRecipesToAwardAndPopExperience$itemstack.set(p_39558_);
            abstractfurnaceblockentity.getRecipesToAwardAndPopExperience$amount.set(this.removeCount);
            abstractfurnaceblockentity.awardUsedRecipesAndPopExperience(serverplayer); // CraftBukkit
        }
