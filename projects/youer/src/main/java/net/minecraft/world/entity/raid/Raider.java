...
public abstract class Raider extends PatrollingMonster {
    ...
    protected void pickUpItem(ItemEntity p_37866_) {
        ...
        if (this.hasActiveRaid()
            ...
            p_37866_.removeReason(org.bukkit.event.entity.EntityRemoveEvent.Cause.PICKUP); // CraftBukkit - add Bukkit remove cause
            p_37866_.discard();
    ...
    public class HoldGroundAttackGoal extends Goal {
        ...
        public void start() {
            ...
            for (Raider raider : this.mob
                ...
                raider.setTargetReason(org.bukkit.event.entity.EntityTargetEvent.TargetReason.FOLLOW_LEADER, true); // CraftBukkit
