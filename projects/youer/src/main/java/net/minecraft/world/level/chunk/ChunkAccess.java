...
public abstract class ChunkAccess implements BlockGetter, BiomeManager.NoiseBiomeSource, LightChunk, StructureAccess, net.neoforged.neoforge.attachment.IAttachmentHolder, ca.spottedleaf.moonrise.patches.starlight.chunk.StarlightChunk { // Folia - rewrite chunk system
    ...
    // Folia start - rewrite chunk system
    ...
    // Folia end - rewrite chunk system
