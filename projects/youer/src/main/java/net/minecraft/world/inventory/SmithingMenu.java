...
public class SmithingMenu extends ItemCombinerMenu {
    ...
    protected void onTake(Player p_150663_, ItemStack p_150664_) {
        ...
        ItemStack itemstack = this.activeQuickItem != null ? this.activeQuickItem : p_150664_;
    ...
    public void createResult() {
        ...
        if (list.isEmpty()) {
            this.resultSlots.fakeSetItem();
            this.resultSlots.setItem(0, ItemStack.EMPTY);
            CraftEventFactory.callPrepareSmithingEvent(getBukkitView(), this.resultSlots.setItem$itemStack()); // CraftBukkit
        } else {
            ...
            if (itemstack.isItemEnabled(this.level.enabledFeatures())) {
                ...
                CraftEventFactory.callPrepareSmithingEvent(getBukkitView(), this.resultSlots.setItem$itemStack());
                // CraftBukkit end
            }
        }
    ...
    private OptionalInt findSlotToQuickMoveTo(ItemStack p_295440_) {
        return this.recipes
            .stream()
            .flatMapToInt(p_300800_ -> findSlotMatchingIngredient(p_300800_.value(), p_295440_).stream())
