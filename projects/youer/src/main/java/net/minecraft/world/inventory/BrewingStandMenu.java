...
public class BrewingStandMenu extends AbstractContainerMenu {
    ...
    public BrewingStandMenu(int p_39090_, Inventory p_39091_) {
        this(p_39090_, p_39091_, new SimpleContainer(5), new io.papermc.paper.inventory.BrewingSimpleContainerData());
    }
    ...
    public BrewingStandMenu(int p_39093_, Inventory p_39094_, Container p_39095_, ContainerData p_39096_) {
        ...
        checkContainerDataCount(p_39096_, 3); // Paper - Add recipeBrewTime
        ...
        this.addDataSlots(new SimpleContainerData(2) {
            ...
            public int get(final int index) {
                if (index == 0) return 400 * p_39096_.get(index) / p_39096_.get(2);
                return p_39096_.get(index);
            }

            @Override
            public void set(final int index, final int value) {
                p_39096_.set(index, value);
            }
        });
    ...
    static class PotionSlot extends Slot {
        ...
        public static boolean mayPlaceItem(PotionBrewing potionBrewing, ItemStack p_39134_) {
            return potionBrewing.isInput(p_39134_) || p_39134_.is(Items.GLASS_BOTTLE) || potionBrewing.isCustomInput(p_39134_); // Paper - Custom Potion Mixes
        }
    }
}
