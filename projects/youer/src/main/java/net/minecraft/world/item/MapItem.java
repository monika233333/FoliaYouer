...
public class MapItem extends ComplexItem {
                                        ...
                                        for (int j3 = 0; j3 < i; j3++) {
                                            ...
                                            if (k3 <= p_42894_.getMinBuildHeight() + 1) {
                                                ...
                                                do {
                                                    ...
                                                    blockstate.getMapColor(p_42894_, blockpos$mutableblockpos) == MapColor.NONE
                                                        && k3 > p_42894_.getMinBuildHeight()
                                                );
            ...
            if (p_42851_.dimension() == mapitemsaveddata.dimension) {
                ...
                for (int j1 = 0; j1 < 128; j1++) {
                    for (int k1 = 0; k1 < 128; k1++) {
                        Holder<Biome> holder = p_42851_.getUncachedNoiseBiome((l + k1) * i, 0, (i1 + j1) * i); // Paper - Perf: Use seed based lookup for treasure maps
    ...
    public void appendHoverText(ItemStack p_42880_, Item.TooltipContext p_339653_, List<Component> p_42882_, TooltipFlag p_42883_) {
        ...
        MapItemSavedData mapitemsaveddata = mapid != null ? p_339653_.mapData(mapid) : null;
