...
public class VillageSiege implements CustomSpawner {
    ...
    private void trySpawn(ServerLevel p_27017_) {
        ...
        if (vec3 != null) {
            ...
            p_27017_.addFreshEntityWithPassengers(zombie, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.VILLAGE_INVASION); // CraftBukkit
        }
    }
    ...
    public static enum State { // Folia - region threading - public
        SIEGE_CAN_ACTIVATE,
        SIEGE_TONIGHT,
        SIEGE_DONE;
    }
