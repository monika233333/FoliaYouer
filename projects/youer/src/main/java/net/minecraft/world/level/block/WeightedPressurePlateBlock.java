...
public class WeightedPressurePlateBlock extends BasePressurePlateBlock {
    ...
    protected int getSignalStrength(Level p_58213_, BlockPos p_58214_) {
        ...
        int i = 0;
        for (Entity entity : getEntities(p_58213_, TOUCH_AABB.move(p_58214_), Entity.class)) {
            org.bukkit.event.Cancellable cancellable;

            if (entity instanceof net.minecraft.world.entity.player.Player) {
                cancellable = CraftEventFactory.callPlayerInteractEvent((net.minecraft.world.entity.player.Player) entity, org.bukkit.event.block.Action.PHYSICAL, p_58214_, null, null, null);
            } else {
