    ...
    public InteractionResult useOn(UseOnContext p_41297_) {
        ...
        if (blockstate2 == null) {
            ...
            if (BaseFireBlock.canBePlacedAt(level, blockpos1, p_41297_.getHorizontalDirection())) {
                ...
                if (player != null && CraftEventFactory.callBlockIgniteEvent(level, blockpos1, org.bukkit.event.block.BlockIgniteEvent.IgniteCause.FLINT_AND_STEEL, player).isCancelled()) {
            ...
            // CraftBukkit start - Store the clicked block
            if (player != null && CraftEventFactory.callBlockIgniteEvent(level, blockpos, org.bukkit.event.block.BlockIgniteEvent.IgniteCause.FLINT_AND_STEEL, player).isCancelled()) {
                p_41297_.getItemInHand().hurtAndBreak(1, player, LivingEntity.getSlotForHand(p_41297_.getHand()));
                return InteractionResult.PASS;
            }
            // CraftBukkit end
