...
public class JukeboxBlockEntity extends BlockEntity implements Clearable, ContainerSingleItem.BlockContainerSingleItem {
    ...
    public int getMaxStackSize() {
        return Math.max(ContainerSingleItem.BlockContainerSingleItem.super.getMaxStackSize(), maxStack);
    }
    ...
    public void setSongItemWithoutPlaying(ItemStack p_350615_) {
        this.item = p_350615_;
        JukeboxSong.fromStack(this.level != null ? this.level.registryAccess() : org.bukkit.craftbukkit.CraftRegistry.getMinecraftRegistry(), p_350615_)
    ...
    public void setSongItemWithoutPlaying(ItemStack p_350615_, long ticksSinceSongStarted) { // CraftBukkit - add argument
        ...
        JukeboxSong.fromStack(this.level != null ? this.level.registryAccess() : org.bukkit.craftbukkit.CraftRegistry.getMinecraftRegistry(), p_350615_)
                .ifPresent(p_350672_ -> this.jukeboxSongPlayer.setSongWithoutPlaying(p_350672_, ticksSinceSongStarted));
    ...
    public void tryForcePlaySong() {
        JukeboxSong.fromStack(this.level != null ? this.level.registryAccess() : org.bukkit.craftbukkit.CraftRegistry.getMinecraftRegistry(), this.getTheItem())
