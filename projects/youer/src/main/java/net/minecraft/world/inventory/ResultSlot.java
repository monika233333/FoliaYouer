...
public class ResultSlot extends Slot {
    ...
    public void onTake(Player p_150638_, ItemStack p_150639_) {
        ...
        NonNullList<ItemStack> nonnulllist = p_150638_.level().getRecipeManager().getRemainingItemsForPaper(RecipeType.CRAFTING, craftinginput, p_150638_.level(), this.craftSlots.getCurrentRecipe()); // Paper - Perf: Improve mass crafting; check last recipe used first
