...
public class PowderSnowBlock extends Block implements BucketPickup {
    ...
    protected void entityInside(BlockState p_154263_, Level p_154264_, BlockPos p_154265_, Entity p_154266_) {
        if (!new io.papermc.paper.event.entity.EntityInsideBlockEvent(p_154266_.getBukkitEntity(), org.bukkit.craftbukkit.block.CraftBlock.at(p_154264_, p_154265_)).callEvent()) { return; } // Paper - Add EntityInsideBlockEvent
        ...
        if (!p_154264_.isClientSide) {
            ...
            if (p_154266_.isOnFire() && p_154266_.mayInteract(p_154264_, p_154265_)) {
                if (!CraftEventFactory.callEntityChangeBlockEvent(p_154266_, p_154265_, Blocks.AIR.defaultBlockState(), !(p_154264_.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) || p_154266_ instanceof Player))) {
                    return;
                }
                // CraftBukkit end
    ...
    @Override
    public ItemStack pickupBlock(@Nullable Player p_295645_, LevelAccessor p_154281_, BlockPos p_154282_, BlockState p_154283_) {
