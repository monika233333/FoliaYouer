...
public abstract class BossEvent {
    ...
    public void setOverlay(BossEvent.BossBarOverlay p_18855_) {
        if (this.adventure != null) this.adventure.overlay(io.papermc.paper.adventure.PaperAdventure.asAdventure(p_18855_)); // Paper
    ...
    public BossEvent setDarkenScreen(boolean p_18857_) {
        if (this.adventure != null) io.papermc.paper.adventure.PaperAdventure.setFlag(this.adventure, net.kyori.adventure.bossbar.BossBar.Flag.DARKEN_SCREEN, p_18857_); // Paper
    ...
    public BossEvent setPlayBossMusic(boolean p_18858_) {
        if (this.adventure != null) io.papermc.paper.adventure.PaperAdventure.setFlag(this.adventure, net.kyori.adventure.bossbar.BossBar.Flag.PLAY_BOSS_MUSIC, p_18858_); // Paper
        this.playBossMusic = p_18858_;
        return this;
    }

    public BossEvent setCreateWorldFog(boolean p_18859_) {
        if (this.adventure != null) io.papermc.paper.adventure.PaperAdventure.setFlag(this.adventure, net.kyori.adventure.bossbar.BossBar.Flag.CREATE_WORLD_FOG, p_18859_); // Paper
