...
public class LevelTicks<T> implements LevelTickAccess<T> {
    ...
    // Folia start - region threading - add world and isBlock
    public net.minecraft.server.level.ServerLevel world;
    public boolean isBlock;

    public LevelTicks(LongPredicate tickingFutureReadyPredicate, Supplier<ProfilerFiller> profilerGetter, net.minecraft.server.level.ServerLevel world, boolean isBlock) {
        this.world = world;
