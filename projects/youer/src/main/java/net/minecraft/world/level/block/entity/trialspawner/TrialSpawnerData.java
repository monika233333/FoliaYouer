...
public class TrialSpawnerData {
    ...
    public int countAdditionalPlayers(BlockPos p_312262_) {
        if (false && this.detectedPlayers.isEmpty()) {
    ...
    public void resetAfterBecomingOminous(TrialSpawner p_338478_, ServerLevel p_338185_) {
        this.currentMobs.stream().map(p_338185_::getEntity).forEach(p_351984_ -> {
            if (p_351984_ != null) {
                ...
                p_351984_.removeReason(org.bukkit.event.entity.EntityRemoveEvent.Cause.DESPAWN);
                p_351984_.remove(Entity.RemovalReason.DISCARDED); // CraftBukkit - Add bukkit remove cause;
            }
        });
