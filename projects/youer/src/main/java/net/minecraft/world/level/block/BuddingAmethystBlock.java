        ...
        if (p_220901_.nextInt(5) == 0) {
            ...
            if (block != null) {
                ...
                if (block == Blocks.SMALL_AMETHYST_BUD) {
                    org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockSpreadEvent(p_220899_, p_220900_, blockpos, blockstate1); // CraftBukkit
                } else {
                    org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(p_220899_, blockpos, blockstate1);
                }
