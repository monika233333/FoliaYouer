...
public class Cow extends Animal {
    ...
    public InteractionResult mobInteract(Player p_28298_, InteractionHand p_28299_) {
        ...
        if (itemstack.is(Items.BUCKET) && !this.isBaby()) {
            ...
            org.bukkit.event.player.PlayerBucketFillEvent event = CraftEventFactory.callPlayerBucketFillEvent((ServerLevel) p_28298_.level(), p_28298_, this.blockPosition(), this.blockPosition(), null, itemstack, Items.MILK_BUCKET, p_28299_);

            if (event.isCancelled()) {
                p_28298_.containerMenu.sendAllDataToRemote(); // Paper - Fix inventory desync
