...
public class CropBlock extends BushBlock implements BonemealableBlock {
    ...
    protected void randomTick(BlockState p_221050_, ServerLevel p_221051_, BlockPos p_221052_, RandomSource p_221053_) {
        ...
        if (p_221051_.getRawBrightness(p_221052_, 0) >= 9) {
            ...
            if (i < this.getMaxAge()) {
                ...
                if (net.neoforged.neoforge.common.CommonHooks.canCropGrow(p_221051_, p_221052_, p_221050_, p_221053_.nextFloat() < (modifier / (100.0f * (Math.floor((25.0F / f) + 1)))))) { // Spigot - SPIGOT-7159: Better modifier resolution
                    // Spigot end
    ...
    protected void entityInside(BlockState p_52277_, Level p_52278_, BlockPos p_52279_, Entity p_52280_) {
        if (!new io.papermc.paper.event.entity.EntityInsideBlockEvent(p_52280_.getBukkitEntity(), org.bukkit.craftbukkit.block.CraftBlock.at(p_52278_, p_52279_)).callEvent()) { return; } // Paper - Add EntityInsideBlockEvent
        if (p_52280_ instanceof Ravager &&
            net.neoforged.neoforge.event.EventHooks.canEntityGrief(p_52278_, p_52280_) &&
            CraftEventFactory.callEntityChangeBlockEvent(p_52280_, p_52279_, Blocks.AIR.defaultBlockState(), true)) { // CraftBukkit
