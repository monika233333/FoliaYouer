...
public abstract class AbstractPiglin extends Monster {
    ...
    protected void finishConversion(ServerLevel p_34663_) {
        this.transformReasonAndspawnReason(org.bukkit.event.entity.EntityTransformEvent.TransformReason.PIGLIN_ZOMBIFIED, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.PIGLIN_ZOMBIFIED);  // CraftBukkit - add spawn and transform reasons
