...
public class Sheep extends Animal implements Shearable {
    ...
    public void shear(SoundSource p_29819_) {
        ...
        for (final ItemStack drop : shear$drops.isEmpty() ? generateDefaultDrops() : shear$drops) { // Paper - custom shear drops (moved drop generation to separate method)
            this.forceDrops = true; // CraftBukkit
            ItemEntity itementity = this.spawnAtLocation(drop, 1);
