    ...
    CauldronInteraction SHULKER_BOX = (p_346995_, p_346996_, p_346997_, p_346998_, p_346999_, p_347000_) -> {
        ...
        if (!(block instanceof ShulkerBoxBlock)) {
            ...
            if (!p_346996_.isClientSide) {
                // CraftBukkit start
                if (!LayeredCauldronBlock.lowerFillLevel(p_346995_, p_346996_, p_346997_, p_346998_, CauldronLevelChangeEvent.ChangeReason.SHULKER_WASH)) {
    ...
    CauldronInteraction BANNER = (p_347001_, p_347002_, p_347003_, p_347004_, p_347005_, p_347006_) -> {
        ...
        if (bannerpatternlayers.layers().isEmpty()) {
            ...
            if (!p_347002_.isClientSide) {
                // CraftBukkit start
                if (!LayeredCauldronBlock.lowerFillLevel(p_347001_, p_347002_, p_347003_, p_347004_, CauldronLevelChangeEvent.ChangeReason.BANNER_WASH)) {
                    return ItemInteractionResult.SUCCESS;
                }
                // CraftBukkit end
    ...
    CauldronInteraction DYED_ITEM = (p_329837_, p_329838_, p_329839_, p_329840_, p_329841_, p_329842_) -> {
        if (!p_329842_.is(ItemTags.DYEABLE)) {
            ...
            if (!p_329838_.isClientSide) {
                // CraftBukkit start
                if (!LayeredCauldronBlock.lowerFillLevel(p_329837_, p_329838_, p_329839_, p_329840_, CauldronLevelChangeEvent.ChangeReason.ARMOR_WASH)) {
                    return ItemInteractionResult.SUCCESS;
                }
                // CraftBukkit end
        ...
        map.put(Items.POTION, (p_329825_, p_329826_, p_329827_, p_329828_, p_329829_, p_329830_) -> {
            ...
            if (potioncontents != null && potioncontents.is(Potions.WATER)) {
                if (!p_329826_.isClientSide) {
                    // CraftBukkit start
                    if (!LayeredCauldronBlock.changeLevel(p_329825_, p_329826_, p_329827_, Blocks.WATER_CAULDRON.defaultBlockState(), p_329828_, CauldronLevelChangeEvent.ChangeReason.BOTTLE_EMPTY)) {
                        return ItemInteractionResult.SUCCESS;
                    }
                    // CraftBukkit end
        ...
        map1.put(
            ...
            (p_329819_, p_329820_, p_329821_, p_329822_, p_329823_, p_329824_) -> {
                if (!p_329820_.isClientSide) {
                    // CraftBukkit start
                    if (!LayeredCauldronBlock.lowerFillLevel(p_329819_, p_329820_, p_329821_, p_329822_, CauldronLevelChangeEvent.ChangeReason.BOTTLE_FILL)) {
                        return ItemInteractionResult.SUCCESS;
                    }
                    // CraftBukkit end
