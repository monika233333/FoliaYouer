...
public enum Direction implements StringRepresentable, ca.spottedleaf.moonrise.patches.collisions.util.CollisionDirection { // Paper - optimise collisions // Folia - moonrise collisions
    ...
    public static Direction getNearest(Vec3 p_333951_) {
        return getNearest(p_333951_.x, p_333951_.y, p_333951_.z);
    }
